...
#min_detection_confidence is to provide flexibilty that how much rigidity we want FROM THE DTECTION MODEL
#min_tracking_confidence to be considerd tracked successfully
